...
query_js = r"""
(() => {
    const style = document.getElementById('ag-complete-rtl-vazir-style');
    const font = document.getElementById('ag-vazirmatn-font');
    return {
        hasStyle: !!style,
        styleTextLength: style ? style.textContent.length : 0,
        styleTextSnippet: style ? style.textContent.substring(0, 150) : '',
        hasFont: !!font,
        fontHref: font ? font.href : ''
    };
})()
"""
